  ...
  return (
        ...
        <BoxWrapper>
          ...
          <div className="pl-4">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-white pl-2">+343</span>
            </div>
          </div>
        </BoxWrapper>
        <BoxWrapper>
          ...
          <div className="pl-4">
            ...
            <div className="flex items-center">
              <strong className="text-xl text-white font-semibold">$3423</strong>
              <span className="text-sm text-white pl-2">-343</span>
            </div>
          </div>
        </BoxWrapper>
        <BoxWrapper>
          ...
          <div className="pl-4">
            ...
            <div className="flex items-center">
              <strong className="text-xl text-white font-semibold">12313</strong>
              <span className="text-sm text-white pl-2">-30</span>
            </div>
          </div>
        </BoxWrapper>
        <BoxWrapper>
          ...
          <div className="pl-4">
            ...
            <div className="flex items-center">
              <strong className="text-xl text-white font-semibold">16432</strong>
              <span className="text-sm text-white pl-2">-43</span>
            </div>
          </div>
        </BoxWrapper>
      </div>
